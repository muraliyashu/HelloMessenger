...
public class contactsAdapter extends BaseAdapter
{
    ...
    public ArrayList<String> statusArray= new ArrayList<String>();
    public Activity context;
    int currentPosition;
    public LayoutInflater inflater;
    public contactsAdapter(Activity context, ArrayList<String> names, ArrayList<String> imagePaths, ArrayList<String> statusArray) {
        super();
    ...
    {
        TextView onlineName, onlineStatus;
    ...
    public View getView(final int position, View convertView, ViewGroup parent)
    {
        try
        {
            ...
            holder.onlineStatus.setText(statusArray.get(position));
